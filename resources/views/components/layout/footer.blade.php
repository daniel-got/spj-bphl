<footer class="bg-surface border-t border-border-custom py-12 px-6 mt-auto">
    <div class="max-w-7xl mx-auto">
        ...
        {{-- Copyright --}}
        <div class="mt-10 pt-6 border-t border-border-custom flex flex-col sm:flex-row justify-between items-center gap-2 text-sm text-muted">
