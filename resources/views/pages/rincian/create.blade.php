            ...
            const html = `
                <div class="penginapan-row relative grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-background border border-border-custom rounded-lg mt-3">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="date" name="rincian_biaya[penginapan][${index}][tgl_menginap]" required
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="date" name="rincian_biaya[penginapan][${index}][tgl_keluar]" required
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="number" name="rincian_biaya[penginapan][${index}][durasi]" readonly placeholder="0"
