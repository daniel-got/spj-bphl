        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-y-auto">
            <main class="grow flex flex-col px-6 py-10">
                <div class="max-w-7xl mx-auto w-full space-y-6">
                    ...
                    <x-layout.page-header title="Daftar Kwitansi" subtitle="Daftar Semua Kwitansi" />

                    <div class="flex flex-col gap-4">
                        <x-layout.card class="p-4 sm:p-6" noPadding>
                            <div class="mb-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                                <h3 class="text-lg font-bold text-text-main">
                                    Daftar Kelola Kwitansi
                                </h3>
                                
                                <form method="GET" action="{{ route('admin.kelola-kwitansi.index') }}" class="w-full sm:w-auto">
