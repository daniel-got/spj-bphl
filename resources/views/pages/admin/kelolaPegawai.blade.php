                        ...
                        <div class="p-4 bg-blue-50 text-blue-700 text-sm rounded-md flex items-start gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <ul class="list-disc pl-4 space-y-1 text-blue-600">
                                    ...
                                    <li>Klik <strong>Cek Data CSV / Excel</strong> untuk memvalidasi sebelum import ke database.
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="flex flex-col gap-1">
                            <label class="text-sm font-medium text-text-main">Upload File CSV / Excel <span
                                    class="text-danger">*</span></label>
